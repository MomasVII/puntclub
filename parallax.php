...
define('FOOT_JS', '
    ...
    '.ROOT.'web/script/scrollmagic.min.js,
    '.ROOT.'web/script/animation.gsap.min.js,
    '.ROOT.'web/script/parallax.js,
    '.ROOT.'web/script/init.js,
    '.ROOT.'web/script/parallax.page.js,
...
require(ROOT . 'web/page/parallax.page.php');
