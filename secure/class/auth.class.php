<?php
    ...
    class auth
    {
        ...
        public function __construct()
        {
            ...
            //if the user want's to sign out or isn't authenticated and we aren't on the login page    if ((isset($_GET['sign_out']) || !$this->is_signed_in()) && $_SERVER['PHP_SELF'] !== '/administration/index.php') {
