...
define('STYLES','
    ...
    '.ROOT.'web/style/photoswipe.css,
    '.ROOT.'web/style/default-skin.min.css,
    '.ROOT.'web/style/gallery.css,
    '.ROOT.'web/style/preloader.css,
');
...
define('FOOT_JS', '
    ...
    '.ROOT.'web/script/navigation.js,
    '.ROOT.'web/script/photoswipe.min.js,
    '.ROOT.'web/script/photoswipe-ui-default.min.js,
    '.ROOT.'web/script/photoswipe-custom.js,
    '.ROOT.'web/script/init.js,
    '.ROOT.'web/script/gallery.page.js,

');

// TODO Add Preloader script when gallery is built
//    '.ROOT.'web/script/preloadjs-0.6.2.min.js,
//    '.ROOT.'web/script/prelaoder.js,
...
require(ROOT . 'web/page/gallery.page.php');
